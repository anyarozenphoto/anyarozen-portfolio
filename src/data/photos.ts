// To change photos: just replace the URLs below with your own image links.
// Hero image is shown full-screen on the home page.
// The "portraits" array is shown in the gallery grid.
